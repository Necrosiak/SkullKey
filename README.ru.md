...
- 🏛️ **Classics Reborn** — 47 нативных open-source портов и рекомпиляций классики (Zelda, Mario 64, Perfect Dark, Diablo, Fallout, Doom, C&C Generals, Morrowind, Sonic Unleashed…), установка из официальных релизов каждого проекта, с понятными инструкциями для ваших оригинальных файлов игры (9 языков)
