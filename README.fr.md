...
- 🏛️ **Classics Reborn** — 47 ports natifs open source et recompilations de classiques (Zelda, Mario 64, Perfect Dark, Diablo, Fallout, Doom, C&C Generals, Morrowind, Sonic Unleashed…), installés depuis les releases officielles de chaque projet, avec des instructions claires pour vos fichiers de jeu originaux (9 langues)
