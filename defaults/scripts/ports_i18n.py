...
DESCS = {
    ...
    "opentesarena": {
        "en": "OpenTESArena — an open-source engine reimplementation of The Elder Scrolls: Arena, Bethesda's first Elder Scrolls. Arena is free, so all the data is easy to get; still work-in-progress but explorable.",
        "fr": "OpenTESArena — réimplémentation open source du moteur de The Elder Scrolls: Arena, le tout premier Elder Scrolls de Bethesda. Arena est gratuit, les données s'obtiennent facilement ; encore en chantier mais explorable.",
        "de": "OpenTESArena — quelloffene Engine-Neuimplementierung von The Elder Scrolls: Arena, Bethesdas erstem Elder Scrolls. Arena ist kostenlos, die Daten leicht zu bekommen; noch in Arbeit, aber erkundbar.",
        "es": "OpenTESArena — reimplementación open source del motor de The Elder Scrolls: Arena, el primer Elder Scrolls de Bethesda. Arena es gratis, los datos son fáciles de conseguir; aún en desarrollo pero explorable.",
        "it": "OpenTESArena — reimplementazione open source del motore di The Elder Scrolls: Arena, il primo Elder Scrolls di Bethesda. Arena è gratuito, i dati si trovano facilmente; ancora in sviluppo ma esplorabile.",
        "pt": "OpenTESArena — reimplementação open source do motor de The Elder Scrolls: Arena, o primeiro Elder Scrolls da Bethesda. Arena é grátis, os dados são fáceis de obter; ainda em desenvolvimento mas explorável.",
        "nl": "OpenTESArena — opensource-herimplementatie van de engine van The Elder Scrolls: Arena, Bethesda's eerste Elder Scrolls. Arena is gratis, dus de data is makkelijk te krijgen; nog in ontwikkeling maar verkenbaar.",
        "pl": "OpenTESArena — otwarta reimplementacja silnika The Elder Scrolls: Arena, pierwszego Elder Scrolls Bethesdy. Arena jest darmowa, dane łatwo zdobyć; wciąż w budowie, ale można zwiedzać.",
        "ru": "OpenTESArena — открытая реализация движка The Elder Scrolls: Arena, первой Elder Scrolls от Bethesda. Arena бесплатна, данные легко достать; ещё в разработке, но уже можно исследовать.",
    },
    "bstone": {
        "en": "BStone — a modern source port of Blake Stone: Aliens of Gold & Planet Strike, the classic Wolfenstein-engine FPS. High resolutions, widescreen, mouse look. Copy your game data (shareware works) into the folder.",
        "fr": "BStone — port source moderne de Blake Stone: Aliens of Gold & Planet Strike, le FPS classique sur moteur Wolfenstein. Hautes résolutions, écran large, visée souris. Copiez vos données de jeu (le shareware marche) dans le dossier.",
        "de": "BStone — moderner Source-Port von Blake Stone: Aliens of Gold & Planet Strike, dem klassischen Wolfenstein-Engine-Shooter. Hohe Auflösungen, Breitbild, Mauszielen. Kopiere deine Spieldaten (Shareware reicht) in den Ordner.",
        "es": "BStone — port moderno de Blake Stone: Aliens of Gold y Planet Strike, el FPS clásico con motor Wolfenstein. Altas resoluciones, panorámico, apuntado con ratón. Copia tus datos de juego (el shareware vale) en la carpeta.",
        "it": "BStone — port sorgente moderno di Blake Stone: Aliens of Gold e Planet Strike, lo sparatutto classico su motore Wolfenstein. Alte risoluzioni, widescreen, mira col mouse. Copia i dati di gioco (va bene lo shareware) nella cartella.",
        "pt": "BStone — port moderno de Blake Stone: Aliens of Gold e Planet Strike, o FPS clássico com motor Wolfenstein. Altas resoluções, widescreen, mira com rato. Copie os dados do jogo (o shareware serve) para a pasta.",
        "nl": "BStone — moderne source-port van Blake Stone: Aliens of Gold & Planet Strike, de klassieke Wolfenstein-engine-shooter. Hoge resoluties, breedbeeld, muisrichten. Kopieer je speldata (shareware werkt) naar de map.",
        "pl": "BStone — nowoczesny port Blake Stone: Aliens of Gold i Planet Strike, klasycznego FPS-a na silniku Wolfensteina. Wysokie rozdzielczości, panorama, celowanie myszą. Skopiuj dane gry (shareware wystarczy) do folderu.",
        "ru": "BStone — современный порт Blake Stone: Aliens of Gold и Planet Strike, классического шутера на движке Wolfenstein. Высокие разрешения, широкий экран, прицеливание мышью. Скопируйте данные игры (подойдёт shareware) в папку.",
    },
    "arx-libertatis": {
        "en": "Arx Libertatis — a cross-platform, bug-fixed port of Arx Fatalis, the cult first-person action-RPG. High resolutions, modern controls, countless fixes. Copy your Arx Fatalis data (GOG/Steam) into the folder.",
        "fr": "Arx Libertatis — port multiplateforme et corrigé d'Arx Fatalis, l'action-RPG à la première personne culte. Hautes résolutions, contrôles modernes, correctifs à foison. Copiez vos données d'Arx Fatalis (GOG/Steam) dans le dossier.",
        "de": "Arx Libertatis — plattformübergreifender, fehlerbereinigter Port von Arx Fatalis, dem Kult-Ego-Action-RPG. Hohe Auflösungen, moderne Steuerung, unzählige Fixes. Kopiere deine Arx-Fatalis-Daten (GOG/Steam) in den Ordner.",
        "es": "Arx Libertatis — port multiplataforma y corregido de Arx Fatalis, el RPG de acción en primera persona de culto. Altas resoluciones, controles modernos, innumerables arreglos. Copia tus datos de Arx Fatalis (GOG/Steam) en la carpeta.",
        "it": "Arx Libertatis — port multipiattaforma e corretto di Arx Fatalis, il GDR d'azione in prima persona di culto. Alte risoluzioni, controlli moderni, innumerevoli fix. Copia i dati di Arx Fatalis (GOG/Steam) nella cartella.",
        "pt": "Arx Libertatis — port multiplataforma e corrigido de Arx Fatalis, o RPG de ação na primeira pessoa de culto. Altas resoluções, controlos modernos, inúmeras correções. Copie os dados de Arx Fatalis (GOG/Steam) para a pasta.",
        "nl": "Arx Libertatis — cross-platform, bugvrije port van Arx Fatalis, het cult first-person actie-RPG. Hoge resoluties, moderne besturing, talloze fixes. Kopieer je Arx Fatalis-data (GOG/Steam) naar de map.",
        "pl": "Arx Libertatis — wieloplatformowy, poprawiony port Arx Fatalis, kultowego action-RPG z perspektywy pierwszej osoby. Wysokie rozdzielczości, nowoczesne sterowanie, mnóstwo poprawek. Skopiuj dane Arx Fatalis (GOG/Steam) do folderu.",
        "ru": "Arx Libertatis — кроссплатформенный, исправленный порт Arx Fatalis, культового экшен-RPG от первого лица. Высокие разрешения, современное управление, множество исправлений. Скопируйте данные Arx Fatalis (GOG/Steam) в папку.",
    },
    "openjazz": {
        "en": "OpenJazz — a free, open-source reimplementation of Jazz Jackrabbit, the classic 90s platformer. Native and fast. Copy the original game files (the shareware episode works) into the folder.",
        "fr": "OpenJazz — réimplémentation libre et open source de Jazz Jackrabbit, le plateformer culte des années 90. Natif et rapide. Copiez les fichiers du jeu original (l'épisode shareware marche) dans le dossier.",
        "de": "OpenJazz — freie, quelloffene Neuimplementierung von Jazz Jackrabbit, dem klassischen 90er-Jump'n'Run. Nativ und schnell. Kopiere die Originaldateien (die Shareware-Episode reicht) in den Ordner.",
        "es": "OpenJazz — reimplementación libre y open source de Jazz Jackrabbit, el plataformas clásico de los 90. Nativo y rápido. Copia los archivos del juego original (el episodio shareware vale) en la carpeta.",
        "it": "OpenJazz — reimplementazione libera e open source di Jazz Jackrabbit, il platform classico degli anni '90. Nativo e veloce. Copia i file del gioco originale (va bene l'episodio shareware) nella cartella.",
        "pt": "OpenJazz — reimplementação livre e open source de Jazz Jackrabbit, o plataformas clássico dos anos 90. Nativo e rápido. Copie os ficheiros do jogo original (o episódio shareware serve) para a pasta.",
        "nl": "OpenJazz — vrije, opensource-herimplementatie van Jazz Jackrabbit, de klassieke jaren-90-platformer. Native en snel. Kopieer de originele spelbestanden (het shareware-deel werkt) naar de map.",
        "pl": "OpenJazz — wolna, otwarta reimplementacja Jazz Jackrabbit, klasycznej platformówki z lat 90. Natywna i szybka. Skopiuj pliki oryginalnej gry (odcinek shareware wystarczy) do folderu.",
        "ru": "OpenJazz — свободная открытая реализация Jazz Jackrabbit, классического платформера 90-х. Нативно и быстро. Скопируйте файлы оригинальной игры (подойдёт shareware-эпизод) в папку.",
    },
    "openbor": {
        "en": "OpenBOR — the open-source Beats of Rage engine: a side-scrolling beat-'em-up engine that runs a huge library of free community-made games (drop a .pak module in and play).",
        "fr": "OpenBOR — le moteur open source Beats of Rage : un moteur de beat-'em-up à défilement qui fait tourner une immense ludothèque de jeux gratuits faits par la communauté (dépose un module .pak et joue).",
        "de": "OpenBOR — die quelloffene Beats-of-Rage-Engine: eine Side-Scrolling-Beat-'em-up-Engine für eine riesige Bibliothek kostenloser Community-Spiele (ein .pak-Modul reinlegen und spielen).",
        "es": "OpenBOR — el motor open source Beats of Rage: un motor de beat-'em-up de scroll lateral que ejecuta una enorme biblioteca de juegos gratuitos hechos por la comunidad (suelta un módulo .pak y juega).",
        "it": "OpenBOR — il motore open source Beats of Rage: un motore beat-'em-up a scorrimento che esegue una enorme libreria di giochi gratuiti della community (metti un modulo .pak e gioca).",
        "pt": "OpenBOR — o motor open source Beats of Rage: um motor beat-'em-up de scroll lateral que corre uma enorme biblioteca de jogos gratuitos feitos pela comunidade (larga um módulo .pak e joga).",
        "nl": "OpenBOR — de opensource Beats of Rage-engine: een side-scrolling beat-'em-up-engine die een enorme bibliotheek gratis community-games draait (zet een .pak-module erin en spelen).",
        "pl": "OpenBOR — otwarty silnik Beats of Rage: silnik beat-'em-up ze scrollem, uruchamiający ogromną bibliotekę darmowych gier społeczności (wrzuć moduł .pak i graj).",
        "ru": "OpenBOR — открытый движок Beats of Rage: движок битэмапа со скроллингом, запускающий огромную библиотеку бесплатных игр сообщества (положите модуль .pak и играйте).",
    },
    "openra-td": {
        "en": "OpenRA: Tiberian Dawn — the original Command & Conquer rebuilt on the modern OpenRA engine. Free (assets downloaded on first run), online multiplayer, modern UI, no CD needed.",
        "fr": "OpenRA : Tiberian Dawn — le Command & Conquer original reconstruit sur le moteur moderne OpenRA. Gratuit (les assets se téléchargent au premier lancement), multijoueur en ligne, interface modernisée, sans CD.",
        "de": "OpenRA: Tiberian Dawn — das originale Command & Conquer auf der modernen OpenRA-Engine. Kostenlos (Assets beim ersten Start geladen), Online-Multiplayer, moderne UI, keine CD nötig.",
        "es": "OpenRA: Tiberian Dawn — el Command & Conquer original reconstruido sobre el motor moderno OpenRA. Gratis (los recursos se descargan al iniciar), multijugador en línea, interfaz moderna, sin CD.",
        "it": "OpenRA: Tiberian Dawn — il Command & Conquer originale ricostruito sul moderno motore OpenRA. Gratuito (asset scaricati al primo avvio), multiplayer online, UI moderna, niente CD.",
        "pt": "OpenRA: Tiberian Dawn — o Command & Conquer original reconstruído no moderno motor OpenRA. Grátis (recursos descarregados no primeiro arranque), multijogador online, interface moderna, sem CD.",
        "nl": "OpenRA: Tiberian Dawn — het originele Command & Conquer herbouwd op de moderne OpenRA-engine. Gratis (assets bij eerste start gedownload), online multiplayer, moderne UI, geen cd nodig.",
        "pl": "OpenRA: Tiberian Dawn — oryginalne Command & Conquer odbudowane na nowoczesnym silniku OpenRA. Darmowe (zasoby pobierane przy pierwszym uruchomieniu), multiplayer online, nowoczesny interfejs, bez płyty.",
        "ru": "OpenRA: Tiberian Dawn — оригинальный Command & Conquer на современном движке OpenRA. Бесплатно (ресурсы качаются при первом запуске), сетевой мультиплеер, современный интерфейс, без диска.",
    },
    "openra-d2k": {
        "en": "OpenRA: Dune 2000 — the classic Westwood RTS Dune 2000 on the modern OpenRA engine. Free (assets downloaded on first run), online multiplayer and modern quality-of-life.",
        "fr": "OpenRA : Dune 2000 — le RTS culte de Westwood Dune 2000 sur le moteur moderne OpenRA. Gratuit (assets téléchargés au premier lancement), multijoueur en ligne et confort moderne.",
        "de": "OpenRA: Dune 2000 — Westwoods klassisches RTS Dune 2000 auf der modernen OpenRA-Engine. Kostenlos (Assets beim ersten Start geladen), Online-Multiplayer und moderner Komfort.",
        "es": "OpenRA: Dune 2000 — el RTS clásico de Westwood Dune 2000 sobre el motor moderno OpenRA. Gratis (recursos descargados al iniciar), multijugador en línea y comodidades modernas.",
        "it": "OpenRA: Dune 2000 — il classico RTS di Westwood Dune 2000 sul moderno motore OpenRA. Gratuito (asset scaricati al primo avvio), multiplayer online e comfort moderno.",
        "pt": "OpenRA: Dune 2000 — o clássico RTS da Westwood Dune 2000 no moderno motor OpenRA. Grátis (recursos descarregados no primeiro arranque), multijogador online e conforto moderno.",
        "nl": "OpenRA: Dune 2000 — het klassieke Westwood-RTS Dune 2000 op de moderne OpenRA-engine. Gratis (assets bij eerste start gedownload), online multiplayer en modern comfort.",
        "pl": "OpenRA: Dune 2000 — klasyczny RTS Westwood Dune 2000 na nowoczesnym silniku OpenRA. Darmowe (zasoby pobierane przy pierwszym uruchomieniu), multiplayer online i nowoczesne udogodnienia.",
        "ru": "OpenRA: Dune 2000 — классический RTS от Westwood Dune 2000 на современном движке OpenRA. Бесплатно (ресурсы качаются при первом запуске), сетевой мультиплеер и современные удобства.",
    },
    "warzone2100": {
        "en": "Warzone 2100 — the 1999 real-time strategy classic, fully open-sourced (game + data are free). Huge tech tree, unit designer, campaign and online multiplayer, actively maintained.",
        "fr": "Warzone 2100 — le classique de stratégie temps réel de 1999, entièrement passé en open source (jeu + données gratuits). Immense arbre technologique, éditeur d'unités, campagne et multijoueur en ligne, maintenu activement.",
        "de": "Warzone 2100 — der Echtzeitstrategie-Klassiker von 1999, vollständig quelloffen (Spiel + Daten kostenlos). Riesiger Techtree, Einheiten-Designer, Kampagne und Online-Multiplayer, aktiv gepflegt.",
        "es": "Warzone 2100 — el clásico de estrategia en tiempo real de 1999, totalmente open source (juego + datos gratis). Enorme árbol tecnológico, diseñador de unidades, campaña y multijugador en línea, mantenido activamente.",
        "it": "Warzone 2100 — il classico strategico in tempo reale del 1999, completamente open source (gioco + dati gratuiti). Enorme albero tecnologico, editor di unità, campagna e multiplayer online, mantenuto attivamente.",
        "pt": "Warzone 2100 — o clássico de estratégia em tempo real de 1999, totalmente open source (jogo + dados grátis). Enorme árvore tecnológica, editor de unidades, campanha e multijogador online, mantido ativamente.",
        "nl": "Warzone 2100 — de real-time strategieklassieker uit 1999, volledig opensource (spel + data gratis). Enorme techtree, unit-ontwerper, campagne en online multiplayer, actief onderhouden.",
        "pl": "Warzone 2100 — klasyk strategii czasu rzeczywistego z 1999 roku, w pełni otwartoźródłowy (gra + dane za darmo). Ogromne drzewko technologii, kreator jednostek, kampania i multiplayer online, aktywnie rozwijany.",
        "ru": "Warzone 2100 — классика стратегии в реальном времени 1999 года, полностью открытая (игра и данные бесплатны). Огромное дерево технологий, редактор юнитов, кампания и сетевой мультиплеер, активно поддерживается.",
    },
    "fs2open": {
        "en": "Freespace 2 on the FreeSpace Open engine — the legendary 1999 space-combat sim with modern graphics (shaders, lighting, high-poly MediaVPs mods), huge community campaigns, native Linux build.",
        "fr": "Freespace 2 sur le moteur FreeSpace Open — la légendaire simulation de combat spatial de 1999 avec graphismes modernes (shaders, éclairage, mods MediaVPs haute définition), immenses campagnes communautaires, build Linux natif.",
        "de": "Freespace 2 auf der FreeSpace-Open-Engine — die legendäre Weltraumkampf-Simulation von 1999 mit moderner Grafik (Shader, Beleuchtung, hochauflösende MediaVPs-Mods), riesigen Community-Kampagnen und nativem Linux-Build.",
        "es": "Freespace 2 sobre el motor FreeSpace Open — el legendario simulador de combate espacial de 1999 con gráficos modernos (shaders, iluminación, mods MediaVPs en alta definición), enormes campañas de la comunidad y build nativa para Linux.",
        "it": "Freespace 2 sul motore FreeSpace Open — il leggendario simulatore di combattimento spaziale del 1999 con grafica moderna (shader, illuminazione, mod MediaVPs in alta definizione), enormi campagne della community e build nativa per Linux.",
        "pt": "Freespace 2 no motor FreeSpace Open — o lendário simulador de combate espacial de 1999 com gráficos modernos (shaders, iluminação, mods MediaVPs em alta definição), enormes campanhas da comunidade e build nativa para Linux.",
        "nl": "Freespace 2 op de FreeSpace Open-engine — de legendarische ruimtegevechtssimulator uit 1999 met moderne graphics (shaders, belichting, high-poly MediaVPs-mods), enorme communitycampagnes en een native Linux-build.",
        "pl": "Freespace 2 na silniku FreeSpace Open — legendarny symulator walk kosmicznych z 1999 roku z nowoczesną grafiką (shadery, oświetlenie, mody MediaVPs w wysokiej rozdzielczości), ogromnymi kampaniami społeczności i natywną wersją na Linuksa.",
        "ru": "Freespace 2 на движке FreeSpace Open — легендарный космический симулятор 1999 года с современной графикой (шейдеры, освещение, HD-моды MediaVPs), огромными фанатскими кампаниями и нативной сборкой для Linux.",
    },
    "oldunreal-ut": {
        "en": "Unreal Tournament (1999) with OldUnreal's official community patch 469: native 64-bit Linux client, modern renderers (Vulkan/OpenGL), fixed netcode and hundreds of bugfixes — the definitive way to play UT99.",
        "fr": "Unreal Tournament (1999) avec le patch communautaire officiel 469 d'OldUnreal : client Linux 64 bits natif, moteurs de rendu modernes (Vulkan/OpenGL), netcode corrigé et des centaines de correctifs — la meilleure façon de jouer à UT99.",
        "de": "Unreal Tournament (1999) mit OldUnreals offiziellem Community-Patch 469: nativer 64-Bit-Linux-Client, moderne Renderer (Vulkan/OpenGL), reparierter Netcode und Hunderte Bugfixes — die beste Art, UT99 zu spielen.",
        "es": "Unreal Tournament (1999) con el parche comunitario oficial 469 de OldUnreal: cliente Linux nativo de 64 bits, renderizadores modernos (Vulkan/OpenGL), netcode corregido y cientos de arreglos — la forma definitiva de jugar a UT99.",
        "it": "Unreal Tournament (1999) con la patch comunitaria ufficiale 469 di OldUnreal: client Linux nativo a 64 bit, renderer moderni (Vulkan/OpenGL), netcode corretto e centinaia di fix — il modo definitivo di giocare a UT99.",
        "pt": "Unreal Tournament (1999) com o patch comunitário oficial 469 da OldUnreal: cliente Linux nativo de 64 bits, renderizadores modernos (Vulkan/OpenGL), netcode corrigido e centenas de correções — a forma definitiva de jogar UT99.",
        "nl": "Unreal Tournament (1999) met OldUnreals officiële communitypatch 469: native 64-bit Linux-client, moderne renderers (Vulkan/OpenGL), gerepareerde netcode en honderden bugfixes — dé manier om UT99 te spelen.",
        "pl": "Unreal Tournament (1999) z oficjalną łatką społeczności 469 od OldUnreal: natywny 64-bitowy klient dla Linuksa, nowoczesne renderery (Vulkan/OpenGL), naprawiony netcode i setki poprawek — najlepszy sposób na UT99.",
        "ru": "Unreal Tournament (1999) с официальным патчем сообщества 469 от OldUnreal: нативный 64-битный Linux-клиент, современные рендеры (Vulkan/OpenGL), исправленный неткод и сотни багфиксов — лучший способ играть в UT99.",
    },
    "isle": {
        "en": "LEGO Island (1997), fully decompiled and made portable: native Linux build, widescreen, high framerates and modern conveniences for the cult classic — bring the files from your original CD-ROM.",
        "fr": "LEGO Island (1997), entièrement décompilé et rendu portable : build Linux natif, écran large, framerate élevé et confort moderne pour le classique culte — apportez les fichiers de votre CD-ROM d'origine.",
        "de": "LEGO Island (1997), vollständig dekompiliert und portabel gemacht: nativer Linux-Build, Breitbild, hohe Frameraten und moderner Komfort für den Kultklassiker — die Dateien kommen von der Original-CD-ROM.",
        "es": "LEGO Island (1997), totalmente descompilado y portado: build nativa para Linux, pantalla panorámica, framerates altos y comodidades modernas para el clásico de culto — aporta los archivos de tu CD-ROM original.",
        "it": "LEGO Island (1997), completamente decompilato e reso portabile: build nativa per Linux, widescreen, framerate elevati e comodità moderne per il classico di culto — servono i file del CD-ROM originale.",
        "pt": "LEGO Island (1997), totalmente descompilado e portado: build nativa para Linux, widescreen, framerates altos e conforto moderno para o clássico cult — traga os arquivos do seu CD-ROM original.",
        "nl": "LEGO Island (1997), volledig gedecompileerd en portable gemaakt: native Linux-build, breedbeeld, hoge framerates en modern comfort voor de cultklassieker — breng de bestanden van je originele cd-rom mee.",
        "pl": "LEGO Island (1997), w pełni zdekompilowane i przeniesione: natywna wersja dla Linuksa, panoramiczny ekran, wysokie klatki i nowoczesne udogodnienia dla kultowego klasyka — potrzebne pliki z oryginalnej płyty CD-ROM.",
        "ru": "LEGO Island (1997), полностью декомпилированный и портированный: нативная сборка для Linux, широкий экран, высокая частота кадров и современные удобства для культовой классики — нужны файлы с оригинального CD-ROM.",
    },
    "librelancer": {
        "en": "Freelancer (2003) re-implemented on the open Librelancer engine: native Linux client with a modern renderer for Digital Anvil's cult space sim — point it at the DATA/EXE folders of a Freelancer installation.",
        "fr": "Freelancer (2003) réimplémenté sur le moteur ouvert Librelancer : client Linux natif avec rendu moderne pour la sim spatiale culte de Digital Anvil — pointez-le vers les dossiers DATA/EXE d'une installation de Freelancer.",
        "de": "Freelancer (2003) auf der offenen Librelancer-Engine neu implementiert: nativer Linux-Client mit modernem Renderer für Digital Anvils Kult-Weltraumsim — einfach auf die DATA/EXE-Ordner einer Freelancer-Installation zeigen.",
        "es": "Freelancer (2003) reimplementado sobre el motor abierto Librelancer: cliente Linux nativo con renderizador moderno para el simulador espacial de culto de Digital Anvil — apúntalo a las carpetas DATA/EXE de una instalación de Freelancer.",
        "it": "Freelancer (2003) reimplementato sul motore aperto Librelancer: client Linux nativo con renderer moderno per il cult spaziale di Digital Anvil — basta indicargli le cartelle DATA/EXE di un'installazione di Freelancer.",
        "pt": "Freelancer (2003) reimplementado no motor aberto Librelancer: cliente Linux nativo com renderizador moderno para o cult espacial da Digital Anvil — aponte para as pastas DATA/EXE de uma instalação do Freelancer.",
        "nl": "Freelancer (2003) opnieuw geïmplementeerd op de open Librelancer-engine: native Linux-client met moderne renderer voor Digital Anvils cult-ruimtesim — wijs naar de DATA/EXE-mappen van een Freelancer-installatie.",
        "pl": "Freelancer (2003) zaimplementowany od nowa na otwartym silniku Librelancer: natywny klient dla Linuksa z nowoczesnym rendererem dla kultowego kosmicznego symulatora Digital Anvil — wskaż foldery DATA/EXE z instalacji Freelancera.",
        "ru": "Freelancer (2003), заново реализованный на открытом движке Librelancer: нативный Linux-клиент с современным рендером для культового космосима Digital Anvil — укажите папки DATA/EXE из установки Freelancer.",
    },
    "openenroth": {
        "en": "Might and Magic VI, VII and VIII on one modern open engine (OpenEnroth): native Linux, one unified engine for the three classic RPGs with quality-of-life fixes — needs the game data from GOG.",
        "fr": "Might and Magic VI, VII et VIII sur un moteur ouvert moderne (OpenEnroth) : Linux natif, un moteur unifié pour les trois RPG classiques avec correctifs de confort — nécessite les données du jeu depuis GOG.",
        "de": "Might and Magic VI, VII und VIII auf einer modernen offenen Engine (OpenEnroth): natives Linux, eine vereinheitlichte Engine für die drei Klassiker-RPGs mit Komfort-Fixes — benötigt die Spieldaten von GOG.",
        "es": "Might and Magic VI, VII y VIII sobre un motor abierto moderno (OpenEnroth): Linux nativo, un motor unificado para los tres RPG clásicos con mejoras de calidad de vida — necesita los datos del juego de GOG.",
        "it": "Might and Magic VI, VII e VIII su un motore aperto moderno (OpenEnroth): Linux nativo, un motore unificato per i tre RPG classici con fix di qualità — servono i dati di gioco da GOG.",
        "pt": "Might and Magic VI, VII e VIII num motor aberto moderno (OpenEnroth): Linux nativo, um motor unificado para os três RPG clássicos com melhorias de conforto — precisa dos dados do jogo da GOG.",
        "nl": "Might and Magic VI, VII en VIII op één moderne open engine (OpenEnroth): native Linux, één geünificeerde engine voor de drie klassieke RPG's met quality-of-life-fixes — heeft de speldata van GOG nodig.",
