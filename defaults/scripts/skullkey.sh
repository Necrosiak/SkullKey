...
# plugins hook into the skeletonkey.sh script by defining a function with the same name as the plugin prefixed with the platform name
# e.g. for the Epic plugin, the function would be Epic_init

PLATFORMS=()
PLATFORM="${1}"

# List of actions that can be performed by the skeletonkey.sh script
